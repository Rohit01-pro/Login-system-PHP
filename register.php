  ...
  <div class="container">
    <div class="box">
      ...
      if (isset($_POST['submit'])) {
        ...
        } else if (strlen($uname) < 6 || strlen($upswd) < 6 || strcmp($upswd, $upswd2));
        else if (mysqli_num_rows(mysqli_query($connection, "Select * from user where uname='{$uname}' OR upswd='{$uemail}';")) > 0) {
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        <div class="form-group">
          ...
          <?php if (isset($_POST['submit']) && strcmp($upswd, $upswd2))
